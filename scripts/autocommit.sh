...
# ============================================
# Auto-commit script for bc-gitlab bootcamp
...
generate_commit_message() {
    ...
    local for_what=""
    case "$type" in
        feat) for_what="add new content for students" ;;
        docs) for_what="improve documentation clarity" ;;
        fix)  for_what="resolve reported issue" ;;
        chore) for_what="maintain project infrastructure" ;;
        ci)   for_what="improve CI/CD pipeline" ;;
        test) for_what="ensure content quality" ;;
        refactor) for_what="improve content structure" ;;
        *)    for_what="enhance bootcamp content" ;;
    esac
    
    local impact=""
    case "$type" in
        feat) impact="students can access new learning materials" ;;
        docs) impact="better understanding for learners" ;;
        fix)  impact="smoother learning experience" ;;
        chore) impact="improved project maintainability" ;;
        ci)   impact="faster and more reliable deployments" ;;
        test) impact="higher confidence in content correctness" ;;
        refactor) impact="easier future development" ;;
...
Auto-committed by bc-gitlab autocommit script
EOF
)
