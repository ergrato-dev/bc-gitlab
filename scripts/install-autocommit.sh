...
SERVICE_NAME="bc-gitlab-autocommit"
...
print_header() {
    echo -e "${BLUE}"
    echo "+============================================+"
    echo "|   BC-GitLab Auto-commit Installer          |"
...
[Unit]
Description=BC-GitLab Bootcamp Auto-commit Service
...
[Unit]
Description=BC-GitLab Bootcamp Auto-commit Timer
