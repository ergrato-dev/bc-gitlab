...
- Crear y gestionar proyectos en GitLab
- Organizar proyectos usando grupos y subgrupos
- Configurar visibilidad y permisos
- Implementar estrategias de branching
- Configurar proteccion de ramas

## Requisitos Previos

- GitLab CE instalado y funcional (Semana 02)
- Git basico (Semana 01)
...
- [ ] Al menos 3 proyectos creados en un grupo
- [ ] Grupo con subgrupos configurados
- [ ] Roles y permisos asignados a 2+ miembros
- [ ] Rama main protegida con reglas

---

[← Semana 02](../week-02-instalacion_gitlab_ce/README.md) | [Semana 04 →](../week-04-issues_merge_requests_y_code_review/README.md)
