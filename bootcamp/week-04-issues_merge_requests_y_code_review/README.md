# Semana 04 — Issues, Merge Requests y Code Review

## Objetivos

- Crear y gestionar Issues (labels, milestones, boards)
- Crear Merge Requests desde ramas
- Realizar Code Review efectivo
- Usar GitLab Flow para el ciclo de desarrollo
- Configurar templates de MR e Issues

## Requisitos Previos

- Proyectos y grupos (Semana 03)
- Git ramas (Semana 01)
...
4. [04-issue-boards/](./2-practicas/04-issue-boards/) — Kanban con GitLab boards

### Proyecto
- [3-proyecto/](./3-proyecto/) — Ciclo completo de desarrollo con GitLab Flow

## Entregables

- [ ] 3+ issues creados con labels
- [ ] 2+ Merge Requests con review
- [ ] Board Kanban configurado
- [ ] Templates de MR e Issues

---

[← Semana 03](../week-03-proyectos_grupos_y_organizacion/README.md) | [Semana 05 →](../week-05-gitlab_ci_cd_fundamentos/README.md)
